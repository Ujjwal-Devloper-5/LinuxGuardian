...
if [[ -n "${_SYSBACKUP_BACKUP_ENGINE_SH_LOADED:-}" ]]; then return 0; fi
_SYSBACKUP_BACKUP_ENGINE_SH_LOADED=1
...
# ── Module Constants ──────────────────────────────────────────
BACKUP_SIZES_LOG="${SYSBACKUP_DATA_DIR:-/var/lib/sysbackup}/data/backup_sizes.log"
